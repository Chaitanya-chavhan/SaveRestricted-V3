...
API_ID = os.getenv("API_ID", "25444204")
API_HASH = os.getenv("API_HASH", "dea52d4d66511a2d11b83383095d0d73")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8254121107:AAHhuW_K_oKuYreyylrF2Z8YY7fUFSQNGt8")
